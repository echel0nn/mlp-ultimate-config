...
hi def semshiBuiltin         ctermfg=207 guifg=#f07199
hi def semshiAttribute       ctermfg=49  guifg=#97dbbe
hi def semshiSelf            ctermfg=249 guifg=#bd93f9
hi def semshiUnresolved      ctermfg=226 guifg=#d1b0cc cterm=underline gui=underline
