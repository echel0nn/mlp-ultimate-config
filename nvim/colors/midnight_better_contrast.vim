...
let s:gb.dark0_hard  = ['#121212', 234]     " 29-32-33
...
let s:gb.gray_245    = ['#808080', 245]     " 146-131-116
let s:gb.gray_244    = ['#828282', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#fbf1c7', 229]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#ffd7af', 223]     " 235-219-178
let s:gb.light2      = ['#d5c4a1', 250]     " 213-196-161
let s:gb.light3      = ['#bdae93', 248]     " 189-174-147
let s:gb.light4      = ['#af8787', 246]     " 168-153-132
let s:gb.light4_256  = ['#af6767', 246]     " 168-153-132

let s:gb.bright_red     = ['#ff5f87', 167]     " 251-73-52
let s:gb.bright_green   = ['#97dbbe', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#f0a8c7', 214]     " 250-189-47
let s:gb.bright_blue    = ['#af87d7', 109]     " 131-165-152
let s:gb.bright_purple  = ['#b092ff', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#d7afd7', 108]     " 142-192-124
let s:gb.bright_orange  = ['#ff5f87', 208]     " 254-128-25
