...
" Last Updated: Fri 11 Nov 2022 13:01:29 +03

" Generated by Colortemplate v2.2.0

hi clear
let g:colors_name = 'midnight8'
...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#121212', '#ff5f87', '#97dbbe', '#97dbbe', '#f0a8c7', '#af87d7', '#b092ff', '#af6767', '#808080', '#ff5f87', '#97dbbe', '#f0a8c7', '#af87d7', '#b092ff', '#d7afd7', '#ffd7af']
  endif
  if has('nvim')
    let g:terminal_color_0 = '#121212'
    let g:terminal_color_1 = '#ff5f87'
    let g:terminal_color_2 = '#97dbbe'
    let g:terminal_color_3 = '#97dbbe'
    let g:terminal_color_4 = '#f0a8c7'
    let g:terminal_color_5 = '#af87d7'
    let g:terminal_color_6 = '#b092ff'
    let g:terminal_color_7 = '#af6767'
    let g:terminal_color_8 = '#808080'
    let g:terminal_color_9 = '#ff5f87'
    let g:terminal_color_10 = '#97dbbe'
    let g:terminal_color_11 = '#f0a8c7'
    let g:terminal_color_12 = '#af87d7'
    let g:terminal_color_13 = '#b092ff'
    let g:terminal_color_14 = '#d7afd7'
    let g:terminal_color_15 = '#ffd7af'
  endif
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    hi Normal guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi CursorLineNr guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi FoldColumn guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi SignColumn guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi VertSplit guifg=#504945 guibg=NONE gui=NONE cterm=NONE
  else
    hi Normal guifg=#ffd7af guibg=#121212 gui=NONE cterm=NONE
    hi CursorLineNr guifg=#f0a8c7 guibg=#121212 gui=NONE cterm=NONE
    hi FoldColumn guifg=#808080 guibg=#121212 gui=NONE cterm=NONE
    hi SignColumn guifg=#ffd7af guibg=#121212 gui=NONE cterm=NONE
    hi VertSplit guifg=#504945 guibg=#121212 gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg=#121212 gui=NONE cterm=NONE
  hi Comment guifg=#808080 guibg=NONE gui=italic cterm=italic
  hi CursorLine guifg=NONE guibg=#121212 gui=NONE cterm=NONE
  hi Error guifg=#ff5f87 guibg=#121212 gui=bold,reverse cterm=bold,reverse
  hi ErrorMsg guifg=#121212 guibg=#ff5f87 gui=bold cterm=bold
  hi Folded guifg=#808080 guibg=#121212 gui=italic cterm=italic
  hi LineNr guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=NONE guibg=#3c3836 gui=bold,underline cterm=bold,underline
  hi NonText guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#ffd7af guibg=#3c3836 gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#3c3836 gui=NONE cterm=NONE
  hi PmenuSel guifg=#3c3836 guibg=#af87d7 gui=bold cterm=bold
  hi PmenuThumb guifg=NONE guibg=#3c3836 gui=NONE cterm=NONE
  hi SpecialKey guifg=#808080 guibg=NONE gui=NONE cterm=NONE
  hi StatusLine guifg=#3c3836 guibg=#ffd7af gui=reverse cterm=reverse
  hi StatusLineNC guifg=#121212 guibg=#af6767 gui=reverse cterm=reverse
  hi TabLine guifg=#3c3836 guibg=#121212 gui=NONE cterm=NONE
  hi TabLineFill guifg=#3c3836 guibg=#121212 gui=NONE cterm=NONE
  hi TabLineSel guifg=#97dbbe guibg=#121212 gui=NONE cterm=NONE
  hi ToolbarButton guifg=#f9f5d7 guibg=#504945 gui=bold cterm=bold
  hi ToolbarLine guifg=NONE guibg=#504945 gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#504945 gui=NONE cterm=NONE
  hi WildMenu guifg=#af87d7 guibg=#3c3836 gui=bold cterm=bold
  hi Conceal guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
  hi Cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi DiffAdd guifg=#97dbbe guibg=#121212 gui=reverse cterm=reverse
  hi DiffChange guifg=#d7afd7 guibg=#121212 gui=reverse cterm=reverse
  hi DiffDelete guifg=#ff5f87 guibg=#121212 gui=reverse cterm=reverse
  hi DiffText guifg=#f0a8c7 guibg=#121212 gui=reverse cterm=reverse
  hi Directory guifg=#97dbbe guibg=NONE gui=bold cterm=bold
  hi EndOfBuffer guifg=#121212 guibg=NONE gui=NONE cterm=NONE
  hi IncSearch guifg=#ff5f87 guibg=#121212 gui=reverse cterm=reverse
  hi ModeMsg guifg=#f0a8c7 guibg=NONE gui=bold cterm=bold
  hi MoreMsg guifg=#f0a8c7 guibg=NONE gui=bold cterm=bold
  hi Question guifg=#ff5f87 guibg=NONE gui=bold cterm=bold
  hi Search guifg=#f0a8c7 guibg=#121212 gui=reverse cterm=reverse
  hi SpellBad guifg=#ff5f87 guibg=NONE guisp=#ff5f87 gui=italic,undercurl cterm=italic,underline
  hi SpellCap guifg=#af87d7 guibg=NONE guisp=#af87d7 gui=italic,undercurl cterm=italic,underline
  hi SpellLocal guifg=#d7afd7 guibg=NONE guisp=#d7afd7 gui=italic,undercurl cterm=italic,underline
  hi SpellRare guifg=#b092ff guibg=NONE guisp=#b092ff gui=italic,undercurl cterm=italic,underline
  hi Title guifg=#97dbbe guibg=NONE gui=bold cterm=bold
  hi WarningMsg guifg=#ff5f87 guibg=NONE gui=bold cterm=bold
  hi Boolean guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
  hi Character guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
  hi Conditional guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Constant guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
  hi Define guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
  hi Debug guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Delimiter guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Error guifg=#ff5f87 guibg=#121212 gui=bold,reverse cterm=bold,reverse
  hi Exception guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Float guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
  hi Function guifg=#97dbbe guibg=NONE gui=bold cterm=bold
  hi Identifier guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
  hi Ignore guifg=fg guibg=NONE gui=NONE cterm=NONE
  hi Include guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
  hi Keyword guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Label guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Macro guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
  hi Number guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
  hi Operator guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
  hi PreCondit guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
  hi Repeat guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi SpecialChar guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi SpecialComment guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Statement guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi StorageClass guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  hi Special guifg=#ff5f87 guibg=NONE gui=italic cterm=italic
  hi String guifg=#97dbbe guibg=NONE gui=italic cterm=italic
  hi Structure guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
  hi Todo guifg=fg guibg=#121212 gui=bold,italic cterm=bold,italic
  hi Type guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
  hi Typedef guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
  hi Underlined guifg=#af87d7 guibg=NONE guisp=#af87d7 gui=underline cterm=underline
  ...
  hi NormalMode guifg=#af6767 guibg=#121212 gui=reverse cterm=reverse
  hi InsertMode guifg=#af87d7 guibg=#121212 gui=reverse cterm=reverse
  hi ReplaceMode guifg=#d7afd7 guibg=#121212 gui=reverse cterm=reverse
  hi VisualMode guifg=#ff5f87 guibg=#121212 gui=reverse cterm=reverse
  hi CommandMode guifg=#b092ff guibg=#121212 gui=reverse cterm=reverse
  hi Warnings guifg=#ff5f87 guibg=#121212 gui=reverse cterm=reverse
  if has('nvim')
    hi! link TermCursor Cursor
    hi TermCursorNC guifg=#121212 guibg=#ffd7af gui=NONE cterm=NONE
  endif
  if get(g:, "gruvbox_plugin_hi_groups", 1)
    hi ALEError guifg=NONE guibg=NONE guisp=#ff5f87 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi ALEWarning guifg=NONE guibg=NONE guisp=#ff5f87 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi ALEInfo guifg=NONE guibg=NONE guisp=#af87d7 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi ALEErrorSign guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi ALEWarningSign guifg=#f0a8c7 guibg=#121212 gui=NONE cterm=NONE
    hi ALEInfoSign guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi BufTabLineCurrent guifg=#121212 guibg=#af6767 gui=NONE cterm=NONE
    hi BufTabLineActive guifg=#af6767 guibg=#3c3836 gui=NONE cterm=NONE
    hi BufTabLineHidden guifg=#3c3836 guibg=#121212 gui=NONE cterm=NONE
    hi BufTabLineFill guifg=#121212 guibg=#121212 gui=NONE cterm=NONE
    hi CocErrorSign guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi CocWarningSign guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi CocInfoSign guifg=#f0a8c7 guibg=#121212 gui=NONE cterm=NONE
    hi CocHintSign guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi CocErrorFloat guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi CocWarningFloat guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi CocInfoFloat guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi CocHintFloat guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPMatch guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPNoEntries guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPPrtBase guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPPrtCursor guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPLinePre guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPMode1 guifg=#af87d7 guibg=#3c3836 gui=bold cterm=bold
    hi CtrlPMode2 guifg=#121212 guibg=#af87d7 gui=bold cterm=bold
    hi CtrlPStats guifg=#af6767 guibg=#3c3836 gui=bold cterm=bold
    if !get(g:, 'gruvbox_bold', 1)
      hi CtrlPMode1 gui=NONE cterm=NONE
      hi CtrlPMode2 gui=NONE cterm=NONE
      hi CtrlPStats gui=NONE cterm=NONE
    endif
    hi DirvishPathTail guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi DirvishArg guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi! link EasyMotionTarget Search
    hi! link EasyMotionShade Comment
    hi gitcommitSelectedFile guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi gitcommitDiscardedFile guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    if get(g:, 'gruvbox_transp_bg', 0)
      hi GitGutterAdd guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
      hi GitGutterChange guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
      hi GitGutterDelete guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
      hi GitGutterChangeDelete guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    else
      hi GitGutterAdd guifg=#97dbbe guibg=#121212 gui=NONE cterm=NONE
      hi GitGutterChange guifg=#d7afd7 guibg=#121212 gui=NONE cterm=NONE
      hi GitGutterDelete guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
      hi GitGutterChangeDelete guifg=#d7afd7 guibg=#121212 gui=NONE cterm=NONE
    endif
    if get(g:, 'indent_guides_auto_colors', 0)
      if get(g:, 'gruvbox_invert_indent_guides', 0)
        hi IndentGuidesOdd guifg=#121212 guibg=#3c3836 gui=reverse cterm=reverse
        hi IndentGuidesEven guifg=#121212 guibg=#121212 gui=reverse cterm=reverse
      else
        hi IndentGuidesOdd guifg=#121212 guibg=#3c3836 gui=NONE cterm=NONE
        hi IndentGuidesEven guifg=#121212 guibg=#121212 gui=NONE cterm=NONE
      endif
    endif
    ...
    hi LspDiagnosticsDefaultError guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi LspDiagnosticsSignError guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi LspDiagnosticsUnderlineError guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LspDiagnosticsDefaultWarning guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi LspDiagnosticsSignWarning guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi LspDiagnosticsUnderlineWarning guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LspDiagnosticsDefaultInformation guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi LspDiagnosticsSignInformation guifg=#f0a8c7 guibg=#121212 gui=NONE cterm=NONE
    hi LspDiagnosticsUnderlineInformation guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LspDiagnosticsDefaultHint guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi LspDiagnosticsSignHint guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi LspDiagnosticsUnderlineHint guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LanguageClientError guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi LanguageClientErrorSign guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi LanguageClientWarning guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi LanguageClientWarningSign guifg=#f0a8c7 guibg=#121212 gui=NONE cterm=NONE
    hi LangaugeClientInfo guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi LanguageClientInfoSign guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi LanguageClientCodeLens guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeDir guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeDirSlash guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeOpenable guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeClosable guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeFile guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeExecFile guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeUp guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeCWD guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeHelp guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeToggleOn guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi NERDTreeToggleOff guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi netrwDir guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi netrwClassify guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi netrwLink guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi netrwSymLink guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi netrwExe guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi netrwComment guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi netrwList guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi netrwHelpCmd guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi netrwCmdSep guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
    hi netrwVersion guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    " Rainbow Parentheses
    if !exists('g:rbpt_colorpairs')
      let g:rbpt_colorpairs = [['blue', '#f0a8c7'], ['magenta', '#af87d7'],
            \ ['red', '#ff5f87'], ['166', '#d7afd7']]
    endif

    let g:rainbow_guifgs = [ '#d7afd7', '#ff5f87', '#af87d7', '#f0a8c7' ]
    ...
    hi ShowMarksHLl guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi ShowMarksHLu guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi ShowMarksHLo guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi ShowMarksHLm guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi SignifySignAdd guifg=#97dbbe guibg=#121212 gui=NONE cterm=NONE
    hi SignifySignChange guifg=#d7afd7 guibg=#121212 gui=NONE cterm=NONE
    hi SignifySignDelete guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi SignatureMarkText guifg=#af87d7 guibg=#121212 gui=NONE cterm=NONE
    hi SignatureMarkerText guifg=#b092ff guibg=#121212 gui=NONE cterm=NONE
    hi StartifyBracket guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
    hi StartifyFile guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi StartifyNumber guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi StartifyPath guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi StartifySlash guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi StartifySection guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi StartifySpecial guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi StartifyHeader guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi StartifyFooter guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi SyntasticError guifg=NONE guibg=NONE guisp=#ff5f87 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SyntasticWarning guifg=NONE guibg=NONE guisp=#f0a8c7 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SyntasticErrorSign guifg=#ff5f87 guibg=#121212 gui=NONE cterm=NONE
    hi SyntasticWarningSign guifg=#f0a8c7 guibg=#121212 gui=NONE cterm=NONE
    hi multiple_cursors_cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
    hi multiple_cursors_visual guifg=NONE guibg=#3c3836 gui=NONE cterm=NONE
    let g:vimshell_escape_colors = [
          \ '#3c3836', '#ff5f87', '#97dbbe', '#f0a8c7',
          \ '#af87d7', '#b092ff', '#d7afd7', '#af6767',
          \ '#121212', '#ff5f87', '#97dbbe', '#ff5f87',
          \ '#af87d7', '#b092ff', '#d7afd7', '#f9f5d7'
          \ ]
  endif
  if get(g:, "gruvbox_filetype_hi_groups", 1)
    hi diffAdded guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi diffRemoved guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi diffChanged guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi diffFile guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi diffNewFile guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi diffLine guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi htmlTag guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi htmlEndTag guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi htmlTagName guifg=#d7afd7 guibg=NONE gui=bold cterm=bold
    hi htmlArg guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi htmlScriptTag guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi htmlTagN guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi htmlSpecialTagName guifg=#d7afd7 guibg=NONE gui=bold cterm=bold
    hi htmlLink guifg=#af6767 guibg=NONE gui=underline cterm=underline
    hi htmlSpecialChar guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi htmlBold guifg=fg guibg=#121212 gui=bold cterm=bold
    hi htmlBoldUnderline guifg=fg guibg=#121212 gui=bold,underline cterm=bold,underline
    hi htmlBoldItalic guifg=fg guibg=#121212 gui=bold,italic cterm=bold,italic
    hi htmlBoldUnderlineItalic guifg=fg guibg=#121212 gui=bold,italic,underline cterm=bold,italic,underline
    hi htmlUnderline guifg=fg guibg=#121212 gui=underline cterm=underline
    hi htmlUnderlineItalic guifg=fg guibg=#121212 gui=italic,underline cterm=italic,underline
    hi htmlItalic guifg=fg guibg=#121212 gui=italic cterm=italic
    hi xmlTag guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi xmlEndTag guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi xmlTagName guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi xmlEqual guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi docbkKeyword guifg=#d7afd7 guibg=NONE gui=bold cterm=bold
    hi xmlDocTypeDecl guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi xmlDocTypeKeyword guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi xmlCdataStart guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi xmlCdataCdata guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi dtdFunction guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi dtdTagName guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi xmlAttrib guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi xmlProcessingDelim guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi dtdParamEntityPunct guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi dtdParamEntityDPunct guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi xmlAttribPunct guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi xmlEntity guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi xmlEntityPunct guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi vimCommentTitle guifg=#af6767 guibg=NONE gui=bold cterm=bold
    hi vimNotation guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi vimBracket guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi vimMapModKey guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    ...
    hi clojureKeyword guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi clojureCond guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi clojureSpecial guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi clojureDefine guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi clojureFunc guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi clojureRepeat guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi clojureCharacter guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi clojureStringEscape guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi clojureException guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi clojureRegexp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi clojureRegexpEscape guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    ...
    hi clojureAnonArg guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi clojureVariable guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi clojureMacro guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi clojureMeta guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi clojureDeref guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi clojureQuote guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi clojureUnquote guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi cOperator guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi cStructure guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonBuiltin guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonBuiltinObj guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonBuiltinFunc guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonFunction guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi pythonDecorator guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonInclude guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi pythonImport guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi pythonRun guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi pythonCoding guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi pythonOperator guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonException guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonExceptions guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi pythonBoolean guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi pythonDot guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
    hi pythonConditional guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonRepeat guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi pythonDottedName guifg=#97dbbe guibg=NONE gui=bold cterm=bold
    hi cssBraces guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi cssFunctionName guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi cssIdentifier guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi cssClassName guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi cssColor guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi cssSelectorOp guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi cssSelectorOp2 guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi cssImportant guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi cssVendor guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi cssTextProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssAnimationProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssUIProp guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi cssTransformProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssTransitionProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssPrintProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssPositioningProp guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi cssBoxProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssFontDescriptorProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssFlexibleBoxProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssBorderOutlineProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssBackgroundProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssMarginProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssListProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssTableProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssFontProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssPaddingProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssDimensionProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssRenderProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssColorProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi cssGeneratedContentProp guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javaScriptBraces guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javaScriptFunction guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javaScriptIdentifier guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javaScriptMember guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi javaScriptNumber guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi javaScriptNull guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi javaScriptParens guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
    hi javascriptImport guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptExport guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptClassKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptClassExtends guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptDefault guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptClassName guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptClassSuperName guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptGlobal guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptEndColons guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptFuncArg guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptGlobalMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptNodeGlobal guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptBOMWindowProp guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptArrayMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptArrayStaticMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptCacheMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptDateMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptMathStaticMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptURLUtilsProp guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptBOMNavigatorProp guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptDOMDocMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptDOMDocProp guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptBOMLocationMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptBOMWindowMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptStringMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptVariable guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptIdentifier guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptClassSuper guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptFuncKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptAsyncFunc guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptClassStatic guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptOperator guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptForOperator guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptYield guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptExceptions guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptMessage guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptTemplateSB guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptTemplateSubstitution guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptLabel guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptObjectLabel guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptPropertyName guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptLogicSymbols guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptArrowFunc guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi javascriptDocParamName guifg=#af6767 guibg=NONE gui=NONE cterm=NONE
    hi javascriptDocTags guifg=#af6767 guibg=NONE gui=NONE cterm=NONE
    hi javascriptDocNotation guifg=#af6767 guibg=NONE gui=NONE cterm=NONE
    hi javascriptDocParamType guifg=#af6767 guibg=NONE gui=NONE cterm=NONE
    hi javascriptDocNamedParamType guifg=#af6767 guibg=NONE gui=NONE cterm=NONE
    hi javascriptBrackets guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptDOMElemAttrs guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptDOMEventMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptDOMNodeMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptDOMStorageMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptHeadersMethod guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi javascriptAsyncFuncKeyword guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javascriptAwaitFuncKeyword guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsImport guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsExport guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsFrom guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsThis guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi jsParen guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsOperator guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi jsSpreadOperator guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsSpreadExpression guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsClassKeyword guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsClassProperty guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsExtendsKeyword guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsExportDefault guifg=#ff5f87 guibg=NONE gui=bold cterm=bold
    hi jsTemplateBraces guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi jsGlobalNodeObjects guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi jsGlobalObjects guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi jsFunction guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsFuncParens guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi jsFuncBlock guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsParens guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
    hi jsNull guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi jsUndefined guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi jsClassDefinition guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi jsFunctionKey guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsBracket guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsObjectColon guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsObjectProp guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsFuncBraces guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsVariableDef guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi jsObjectValue guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsDestructuringBlock guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi jsParenIfElse guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsClassBlock guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsFutureKeys guifg=#ff5f87 guibg=NONE gui=bold cterm=bold
    hi jsStorageClass guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi jsModuleKeyword guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsObjectShorthandProp guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxRegion guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxTagName guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxComponentName guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi jsxEscapeJsAttributes guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxEscapeJsContent guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxAttrib guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi jsxAttributeBraces guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi jsxEqual guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi jsxString guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsxCloseTag guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxEndTag guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxEndString guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxCloseString guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxIfOperator guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi jsxElseOperator guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi jsxDot guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi jsxNamespace guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi jsxPunct guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi typeScriptReserved guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi typeScriptLabel guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi typeScriptFuncKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi typeScriptIdentifier guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi typeScriptBraces guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi typeScriptEndColons guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi typeScriptDOMObjects guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi typeScriptAjaxMethods guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi typeScriptLogicSymbols guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi! link typeScriptDocSeeTag Comment
    hi! link typeScriptDocParam Comment
    hi! link typeScriptDocTags vimCommentTitle
    hi typeScriptGlobalObjects guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    ...
    hi typeScriptHtmlElemProperties guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi typeScriptNull guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi typeScriptInterpolationDelimiter guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptModuleKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptModuleName guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi purescriptWhere guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptDelimiter guifg=#af6767 guibg=NONE gui=NONE cterm=NONE
    hi purescriptType guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi purescriptImportKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptHidingKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptAsKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptStructure guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptOperator guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi purescriptTypeVar guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi purescriptConstructor guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi purescriptFunction guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi purescriptConditional guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi purescriptBacktick guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    ...
    hi coffeeCurly guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi coffeeParen guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
    hi coffeeBracket guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi rubyStringDelimiter guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi rubyInterpolationDelimiter guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi objcTypeModifier guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi objcDirective guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi goDirective guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi goConstants guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi goDeclaration guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi goDeclType guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi goBuiltins guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi luaIn guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi luaFunction guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi luaTable guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    ...
    hi moonObject guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi javaAnnotation guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi javaDocTags guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    ...
    hi javaOperator guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi javaVarArg guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi! link elixirDocString Comment
    hi elixirStringDelimiter guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi elixirInterpolationDelimiter guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi elixirModuleDeclaration guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi scalaNameDefinition guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi scalaCaseFollowing guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi scalaCapitalWord guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi scalaTypeExtension guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi scalaKeyword guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi scalaKeywordModifier guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi scalaSpecial guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi scalaOperator guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi scalaTypeDeclaration guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi scalaTypeTypePostDeclaration guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi scalaInstanceDeclaration guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi scalaInterpolation guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi markdownItalic guifg=#bdae93 guibg=NONE gui=italic cterm=italic
    hi markdownH1 guifg=#97dbbe guibg=NONE gui=bold cterm=bold
    hi markdownH2 guifg=#97dbbe guibg=NONE gui=bold cterm=bold
    hi markdownH3 guifg=#f0a8c7 guibg=NONE gui=bold cterm=bold
    hi markdownH4 guifg=#f0a8c7 guibg=NONE gui=bold cterm=bold
    hi markdownH5 guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi markdownH6 guifg=#f0a8c7 guibg=NONE gui=NONE cterm=NONE
    hi markdownCode guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi markdownCodeBlock guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi markdownCodeDelimiter guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi markdownBlockquote guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi markdownListMarker guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi markdownOrderedListMarker guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi markdownRule guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    hi markdownHeadingRule guifg=#808080 guibg=NONE gui=NONE cterm=NONE
    ...
    hi markdownHeadingDelimiter guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi markdownUrl guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi markdownUrlTitleDelimiter guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi markdownLinkText guifg=#808080 guibg=NONE gui=underline cterm=underline
    hi! link markdownIdDeclaration markdownLinkText
    hi haskellType guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi haskellIdentifier guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi haskellSeparator guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi haskellDelimiter guifg=#af6767 guibg=NONE gui=NONE cterm=NONE
    hi haskellOperators guifg=#af87d7 guibg=NONE gui=NONE cterm=NONE
    hi haskellBacktick guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi haskellStatement guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi haskellConditional guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
    hi haskellLet guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellDefault guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellWhere guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellBottom guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellBlockKeywords guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellImportKeywords guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellDeclKeyword guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellDeriving guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellAssocType guifg=#d7afd7 guibg=NONE gui=NONE cterm=NONE
    hi haskellNumber guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi haskellPragma guifg=#b092ff guibg=NONE gui=NONE cterm=NONE
    hi haskellString guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi haskellChar guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsonKeyword guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsonQuote guifg=#97dbbe guibg=NONE gui=NONE cterm=NONE
    hi jsonBraces guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    hi jsonString guifg=#ffd7af guibg=NONE gui=NONE cterm=NONE
    if !s:italics
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#3c3836', '#ff5f87', '#97dbbe', '#97dbbe', '#f0a8c7', '#af87d7', '#b092ff', '#7c6f64', '#928374', '#9d0006', '#79740e', '#b57614', '#076678', '#8f3f71', '#427b58', '#f9f5d7']
  endif
  if has('nvim')
...
" Color: neutralred        #ff5f87    160 DarkRed
" Color: neutralgreen      #97dbbe    100 DarkGreen
" Color: neutralyellow     #97dbbe    172 DarkYellow
" Color: neutralblue       #f0a8c7    66  DarkBlue
" Color: neutralpurple     #af87d7    132 DarkMagenta
" Color: neutralaqua       #b092ff    71  DarkCyan
" Color: neutralorange     #d7afd7    166
" Background: dark
" Color: bg0 rgb(18,18,18) 234 Black
" Color: bg1             #121212     237 DarkGray
" Color: bg2             #3c3836     239
" Color: bg3             #504945      59
" Color: bg4             #3c3836    243
" Color: fg0             #f9f5d7    230
" Color: fg1             #ffd7af    187 White
" Color: fg2             #d5c4a1    187
" Color: fg3             #bdae93    144
" Color: fg4             #af6767    137 Gray
" Color: grey            #808080    102 DarkGray
" Color: red             #ff5f87     203 Red
" Color: green           #97dbbe     142 Green
" Color: yellow          #f0a8c7     214 Yellow
" Color: blue            #af87d7    109 Blue
" Color: purple          #b092ff    175 Magenta
" Color: aqua            #d7afd7    107 Cyan
" Color: orange          #ff5f87     208 Magenta
