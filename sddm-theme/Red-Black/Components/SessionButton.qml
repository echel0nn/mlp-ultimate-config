    ...
    ComboBox {
        ...
        delegate: ItemDelegate {
            ...
            contentItem: Text {
                ...
                color: selectSession.highlightedIndex === index ? "#6f2439" : root.palette.text
                verticalAlignment: Text.AlignVCenter
                horizontalAlignment: Text.AlignHCenter
            }
            highlighted: parent.highlightedIndex === index
            background: Rectangle {
                color: selectSession.highlightedIndex === index ? root.palette.text : "#a33553"
            }
        }
        ...
        background: Rectangle {
            ...
            border.color: "red" // parent.visualFocus ? root.palette.text : "red"
